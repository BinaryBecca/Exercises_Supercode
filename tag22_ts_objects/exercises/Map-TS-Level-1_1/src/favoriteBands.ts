...
bands.set("Metallica", ["James Hetfield", "Lars Ulrich", "Kirk Hammett", "Robert Trujillo"])
bands.set("The Rolling Stones", ["Mick Jagger", "Keith Richards", "Charlie Watts", "Ronnie Wood"])
bands.set("U2", ["Bono", "The Edge", "Adam Clayton", "Larry Mullen Jr."])
